...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<GetLoggedDriver> getLoggedUserData() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetLoggedDriver>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetLoggedDriver _value;
    try {
      _value = GetLoggedDriver.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<VehicleEntity> getVehicleInfo() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<VehicleEntity>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/v1/vehicles',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VehicleEntity _value;
    try {
      _value = VehicleEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
